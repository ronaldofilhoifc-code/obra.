    ...
    <div class="container-fluid color">
        <div class="row knocktotheleft">
            ...
            <div class="col-md-11 main-boot">
                <form name="form-perfil" class="form-pesquisa">
                                ...
                                <div class="split75">
                                    ...
                                    <div class="super-input-holder">
                                        ...
                                        <div class="input-holder">
                                            <input type="text" id="pesquisaPerfil" class="input-pesquisa"
                                                placeholder="Pesquise algo sobre seu perfil!">
                                        </div>
                            ...
                            <div class="mimdepapai">
                                <div class="split50">
                                    ...
                                    if (isset($_COOKIE["usuarioLogado"])) {
                                        echo $_COOKIE["usuarioLogado"] . "cookie";
                                    } else if (isset($_SESSION["usuarioLogado"])) {
                                        echo $_SESSION["usuarioLogado"] . "sessão";
                                    }
